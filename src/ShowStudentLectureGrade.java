...
public class ShowStudentLectureGrade extends JFrame  {
	...
	public ShowStudentLectureGrade(Object stno) {
		super("ShowStudentLectureGrade");
	...
	public void showTable(){		//테이블에 보여줄화면 정의
		...
		try {
			...
			//실제 사용할거
			String query = "select * from coursehistory where stno="+stno;

...
public class PCheckYearSemester extends JFrame implements ActionListener  {

	JButton btnShow,btnCancel;
	JTextField professorID, year,semester;
	...
	public PCheckYearSemester() {
		super("PCheckYearSemester");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (B == btnShow) {
			...
			if(cnt==1) {		//pid가 존재하면
				System.out.println(cnt);
				new ShowProfessorLecture(pID,y,s);
			}else {		//존재하지 않으면

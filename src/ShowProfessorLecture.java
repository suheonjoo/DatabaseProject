...
public class ShowProfessorLecture extends JFrame implements ActionListener  {
	...
	public ShowProfessorLecture(String pID,String y,String s) {
		super("ShowProfessorLecture");
		//this.frame = frame;
	...
	public void showTable(){		//테이블에 보여줄화면 정의
		...
		//초기 테이블 설정
		System.out.println("강의하는 강의정보를 보여줍니다.");
		Table_Name=lecture;		
		...
		try {
			...
			//실제 사용할거
			String query = "select * from Lecture where lno=(select lno from coursehistory where cyear="+y+" and semester="+s+" and pno="+pID+" );";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnShow) {
			...
			Object lno=table.getModel().getValueAt(row, 0 );
			
			
			new ShowStudentInformation(lno);
